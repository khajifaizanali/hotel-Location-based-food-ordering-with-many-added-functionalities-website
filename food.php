...
<body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET" id="hel1">
        <input type="text" name="txtName" id="demo1" style="visibility:hidden;" />
        <center> <input type="submit" value="search my location"></center>
    </form>
    <?php
        if(isset($_GET['txtName'])){
    echo "<center>your location detected</center>";
            $a=explode(" ",$_GET['txtName']);
    $sql="UPDATE tblvendor SET lon=$a[1],lat=$a[0] WHERE fldvendor_id=$vrid ";
